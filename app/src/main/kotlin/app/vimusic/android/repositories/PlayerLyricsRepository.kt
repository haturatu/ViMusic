...
import app.vimusic.providers.newpipe.requests.lyrics
...
interface PlayerLyricsRepository {
    ...
    suspend fun fetchNewPipeMusicLyrics(mediaId: String): String?
...
object DefaultPlayerLyricsRepository : PlayerLyricsRepository {
    ...
    override suspend fun fetchNewPipeMusicLyrics(mediaId: String): String? =
        NewPipeMusic.lyrics(NextBody(videoId = mediaId))?.getOrNull()
