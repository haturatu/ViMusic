...
import app.vimusic.providers.youtubemusic.innertube.models.PlayerResponse
...
private suspend fun YoutubeMusicInnertube.tryContexts(
    body: PlayerBody,
    music: Boolean,
...
suspend fun YoutubeMusicInnertube.player(body: PlayerBody): Result<PlayerResponse?>? = runCatchingCancellable {
    tryContexts(
        body = body,
        music = false,
        Context.DefaultIOS
