package app.vimusic.providers.newpipe
...
import app.vimusic.providers.newpipe.models.Runs
import app.vimusic.providers.newpipe.models.Thumbnail
import app.vimusic.providers.newpipe.models.Context
import app.vimusic.providers.newpipe.models.UserAgents
...
object NewPipeMusic {
    ...
    private val javascriptClient = NewPipeHttpClient()

    val logger = LoggerFactory.getLogger(NewPipeMusic::class.java)
    internal val client = NewPipeHttpClient(defaultApiKey = API_KEY)
