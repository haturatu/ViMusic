 ...
 */
internal class NewPipeHttpClient(
    ...
    suspend fun get(url: String): String = withContext(Dispatchers.IO) {
        execute(
            ...
            url = url,
            headers = mapOf(
                "User-Agent" to app.vimusic.providers.newpipe.models.UserAgents.DESKTOP,
    ...
    suspend fun executePost(
        ...
        headers["User-Agent"] = context?.client?.userAgent
            ?: app.vimusic.providers.newpipe.models.UserAgents.DESKTOP
        context?.let {
